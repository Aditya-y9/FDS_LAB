...
/**
 * An abstract class that implements the TreeInterface and provides default implementations for SOME, not all of its methods.
...
public abstract class AbstractTree<E> implements TreeInterface<E>{
    ...
    public int numChildren(Position<E> p){
        ...
        // children(p) returns an iterable collection of the children of the specified position (p)
        // basically the list of children is stored with each node
