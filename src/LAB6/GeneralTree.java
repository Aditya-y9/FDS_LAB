...
public class GeneralTree<E> extends AbstractTree<E> {
  ...
  /**
   * Returns an iterable collection of the children positions of the given
   * position.
   * @param v the position whose children to return
   * @return an iterable collection of the children positions of the given
   *     position
   * @throws IllegalArgumentException if the position is not valid
   */
  @Override
  ...
  /**
   * Returns true if the given position has one or more children, false
   * otherwise.
   * @param v the position to check
   * @return true if the given position has one or more children, false
   *     otherwise
   * @throws IllegalArgumentException if the position is not valid
   */
  @Override
  ...
  /**
   * Returns true if the given position is the root of the tree, false
   * otherwise.
   * @param v the position to check
  ...
  private void preorderSubtree(Position<E> p, List<Position<E>> snapshot) {
    ...
    snapshot.add(
        p); // for preorder, we add position p before exploring subtrees
   ...
   * @throws IllegalArgumentException if the position is not valid or the given
   *     tree is empty
   */
  ...
  /**
   * Returns an iterable collection of the sibling positions of the given
   * position.
   * @param p the position whose siblings to return
   * @return an iterable collection of the sibling positions of the given
   *     position
   * @throws IllegalArgumentException if the position is not valid
   */
  ...
  /**
   * Adds the leaf positions in the subtree rooted at the given position to the
   * given list.
  ...
  /**
   * Adds the internal node positions in the subtree rooted at the given
   * position to the given list.
   * @param p the root position of the subtree
  ...
  /**
   * Adds the edge positions in the subtree rooted at the given position to the
   * given list.
   * @param p the root position of the subtree
  ...
  public int height() {
    ...
    for (Position<E> p : leaves()) {
      ...
      if (isExternal(p)) {
        // if the node is a leaf, get the depth and compare it with the current
        // height
  ...
  /**
   * Displays the tree with the given position as the root, using the given
   * label for each node.
   ...
   * @throws IllegalArgumentException if the position is not valid
   */
  public void display(Position<E> p, int level, String label)
      throws IllegalArgumentException {
  ...
  /**
   * Returns the position of the node containing the given element, or null if
   * the element is not found.
   * @param e the element to search for
   * @return the position of the node containing the given element, or null if
   *     the element is not found\
   * Funtion Overloading
   */
  ...
  /**
   * Returns the position of the node containing the given element in the
   * subtree rooted at the given position, or null if the element is not found.
   * @param p the root position of the subtree to search
   * @param e the element to search for
   * @return the position of the node containing the given element in the
   *     subtree rooted at the given position, or null if the element is not
   *     found
   */
